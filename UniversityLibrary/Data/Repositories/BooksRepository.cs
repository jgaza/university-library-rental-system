...
namespace UniversityLibrary.Data.Repositories
{
	...
	{
		private readonly UniversityLibraryContext _context;

		public BooksRepository(UniversityLibraryContext context)
		{
			_context = context;
		}
		...
		public async Task<Book?> GetBookByIDAsync(int? id) => await _context.Book.FirstOrDefaultAsync(m => m.ID == id);
